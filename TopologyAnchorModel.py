...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes, n_points):
        ...
        self.loc_conv4_3 = DeformConv2d(512, n_boxes['conv4_3'] * (n_points * 2 + 2), kernel_size=3, padding=1)
        self.loc_conv7 = DeformConv2d(1024, n_boxes['conv7'] * (n_points * 2 + 2), kernel_size=3, padding=1)
        self.loc_conv8_2 = DeformConv2d(512, n_boxes['conv8_2'] * (n_points * 2 + 2), kernel_size=3, padding=1)
        self.loc_conv9_2 = DeformConv2d(256, n_boxes['conv9_2'] * (n_points * 2 + 2), kernel_size=3, padding=1)
        self.loc_conv10_2 = nn.Conv2d(256, n_boxes['conv10_2'] * (n_points * 2 + 2), kernel_size=3, padding=1)
        self.loc_conv11_2 = nn.Conv2d(256, n_boxes['conv11_2'] * (n_points * 2 + 2), kernel_size=3, padding=1)
