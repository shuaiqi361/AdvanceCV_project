...
from TopologyPointModel import SSD300, MultiBoxLoss
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if epoch >= 30 and epoch % 30 == 0 or epoch == 3:
            ...
            if current_mAP > best_mAP:
                save_checkpoint(epoch, model, optimizer, name='checkpoints/my_checkpoint_topo_point_b32.pth.tar')
...
def evaluate(test_loader, model):
    ...
    with torch.no_grad():
        ...
        for i, (images, boxes, labels, difficulties) in enumerate(tqdm(test_loader, desc='Evaluating')):
            ...
            predicted_locs, predicted_scores, rep_points = model(images)
            time_end = time.time()
