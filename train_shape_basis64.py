...
from AnchorShape64Model import SSD300, MultiBoxLoss
...
f_log = open('log/train_shape_basis64_refine_log.txt', 'w')
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if epoch >= 15 and epoch % 40 == 0 or epoch == 10:
            ...
            if current_mAP > best_mAP:
                save_checkpoint(epoch, model, optimizer, name='checkpoints/my_checkpoint_refine_shape_basis64.pth.tar')
