...
class PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv4_3_feats, conv7_feats, conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats):
        ...
        l_conv7 = l_conv7.view(batch_size, -1,
                               4)  # (N, 2166, 4), there are a total 2116 boxes on this feature map
...
class SSD300(nn.Module):
    ...
    def forward(self, image):
        ...
        return locs, classes_scores, locs
    ...
    def detect_objects(self, predicted_locs, predicted_scores, rep_points, min_score, max_overlap, top_k):
        ...
        for i in range(batch_size):
            ...
            decoded_locs = cxcy_to_xy(gcxgcy_to_cxcy(predicted_locs[i], self.priors_cxcy))  # predict bbox coordinates directly
